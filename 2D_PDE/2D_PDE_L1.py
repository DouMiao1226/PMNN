...
def save_error(error_collect):
    np.savetxt('loss/error_2D_PDE_L1.txt', error_collect)


def save_loss(i_loss_collect, b_loss_collect, f_loss_collect, total_loss):
    np.savetxt('loss/i_loss_2D_PDE_L1.txt', i_loss_collect)
    np.savetxt('loss/b_loss_2D_PDE_L1.txt', b_loss_collect)
    np.savetxt('loss/f_loss_2D_PDE_L1.txt', f_loss_collect)
    np.savetxt('loss/total_loss_2D_PDE_L1.txt', total_loss)
...
def exact_draw_some_t(t_num_index):
    ...
    plt.tight_layout()
    plt.savefig('Figure/2D_PDE/2D_PDE_L1_t_' + str(t_test[t_num_index]) + 'NN_exact.png')
    plt.show()
...
def pred_draw_some_t(t_num_index):
    ...
    plt.tight_layout()
    plt.savefig('Figure/2D_PDE/2D_PDE_L1_t_' + str(t_test[t_num_index]) + 'NN_learn.png')
    plt.show()
...
def error_draw_some_t(t_num_index):
    ...
    plt.title('$t = %.2f $' % (t_test[t_num_index]))
    plt.tight_layout()
    plt.savefig('Figure/2D_PDE/2D_PDE_L1_t_' + str(t_test[t_num_index]) + 'NN_Error.png')
    plt.show()
...
def error_1_draw_some_t(t_num_index):
    ...
    plt.title('Error')
    plt.tight_layout()
    plt.savefig('Figure/2D_PDE/2D_PDE_L1_t_' + str(t_test[t_num_index]) + 'NN_Error_1.png')
    plt.show()
...
def draw_epoch_loss():
    ...
    plt.savefig('Figure/2D_PDE/2D_PDE_L1_LOSS.png')
    plt.show()
...
def draw_epoch_loss_1():
    ...
    plt.savefig('Figure/2D_PDE/2D_PDE_L1_LOSS_1.png')
    plt.show()
