...
class Model:
    ...
    def Lu_and_F(self):
        ...
        return u_n, u_t, u_tt, Lu

    def PDE_loss(self):
        u_n, u_t, u_tt, Lu = self.Lu_and_F()
...
def save_loss(i_loss_collect, b_loss_collect, f_loss_collect, total_loss):
    ...
    np.savetxt('loss/b_loss_3D_PDE_L1.txt', b_loss_collect)
    np.savetxt('loss/f_loss_3D_PDE_L1.txt', f_loss_collect)
    np.savetxt('loss/total_loss_3D_PDE_L1.txt', total_loss)
